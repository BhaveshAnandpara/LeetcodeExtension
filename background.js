...
//     //Interval
//     let userInterval = 0 || await chrome.storage.local.get('interval')

//     const originalTime = ((hr * 60) + min)
//     const now = (time.getHours() * 60) + time.getMinutes()
//     const interval = userInterval.interval

//     console.log(originalTime + " " + now + " " + interval);

//     // if (now == originalTime || now % (originalTime + interval) == 0 || now > originalTime) {

//     //     const data = await chrome.storage.local.get('userInfo')

//     //     console.log("cheking...");

//     //     if (!await checkStatus(data.userInfo)) {
